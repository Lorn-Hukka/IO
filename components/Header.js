...
const Header = () => {
    ...
    const handleClick = (e) => {
        e.preventDefault();
        const szukane = { szukany, selected };
    ...
    return (  
        <div className="md:grid md:grid-cols-3 items-center z-50 shadow pb-4"> 
            ...
            <form className="mx-12 py-2 lg:py-0 md:mx-0 flex justify-between shadow rounded-full">
                <input className ="outline-none rounded-full w-full pl-5" type="text" placeholder="Szukaj..." value= {szukany} onChange={(e) => setSzukany(e.target.value)}/>
                <Link href="/">
                <button onClick={handleClick} className="border-l border-r">
            ...
            <nav className="flex justify-center md:justify-start">
                            <Link href="/contact"><a className="flex items-center rounded-full mt-3 md:mt-0 md:ml-3 lg:ml-20 py-2 px-3 uppercase text-xs font-bold tracking-wider cursor-pointer text-third border-third border-2 hover:bg-third hover:text-white transition ease-out duration-500">Kontakt</a></Link>
                            <Link href="/account"><a className="flex items-center text-center rounded-full mt-3 md:mt-0 mx-3 py-2 px-3 uppercase text-xs font-bold tracking-wider cursor-pointer text-third border-third border-2 hover:bg-third hover:text-white transition ease-out duration-500"><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                        </svg><span className="hidden lg:inline">Twoje konto</span></a></Link>
                            <Link href="/cart"><a className="flex items-center rounded-full mt-3 md:mt-0 py-2 px-3 uppercase text-xs font-bold tracking-wider cursor-pointer text-third border-third border-2 hover:bg-third hover:text-white transition ease-out duration-500"><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
