        ...
        <div className="container mx-auto">
          <div className="max-w-md mx-auto bg-white p-5 rounded-md shadow-sm">
            <div className="text-center">
              <h1 className="my-3 text-3xl font-semibold text-gray-700 dark:text-gray-200">Skontaktuj się z nami</h1>
              <p className="text-gray-400 dark:text-gray-400">Wypełnij formularz poniżej, aby wysłać do nas wiadomość. Odpowiemy jak najszybciej to możliwe.</p>
            </div>
            <div className="m-7">
